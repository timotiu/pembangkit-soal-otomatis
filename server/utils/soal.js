...
async function hasilSoal(inputSoal,tipeSoal,callback){
    let soal=`Buatlah satu soal pilihan ganda tipe soal ${tipeSoal} beserta kunci jawabannya  untuk menguji kemampuan siswa dalam "${inputSoal}"`;
    console.log(soal);
